...
import net.gruporodrix.course.entities.Payment;
import net.gruporodrix.course.entities.Product;
import net.gruporodrix.course.entities.User;
import net.gruporodrix.course.entities.enums.OrderStatus;
import net.gruporodrix.course.repositories.CategoryRepository;
import net.gruporodrix.course.repositories.OrderItemRepository;
import net.gruporodrix.course.repositories.OrderRepository;
import net.gruporodrix.course.repositories.ProductRepository;
